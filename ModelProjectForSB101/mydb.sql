...
CREATE TABLE `orders` (
  ...
  KEY `pro_order_fk` (`pro_id`),
  KEY `user_order_fk` (`user_id`),
  CONSTRAINT `pro_order_fk` FOREIGN KEY (`pro_id`) REFERENCES `product` (`pro_id`) ON DELETE CASCADE,
  CONSTRAINT `user_order_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,1,4,'2023-02-20'),(3,1,3,'2023-02-20'),(4,2,4,'2023-02-20');
...
INSERT INTO `user` VALUES (1,'abc','abc','abc123','2023-02-20'),(2,'bcd','bcd','abc123','2023-02-20');
...
-- Dump completed on 2023-02-20 17:41:01
